...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "XamarinApplicationProperties.Android.dll" comes first in this list. */
		"XamarinApplicationProperties.Android.dll",
		"FormsViewGroup.dll",
		...
		"XamarinApplicationProperties.dll",
	};
