...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "XamarinPickerWithNavigation.Android.dll" comes first in this list. */
		"XamarinPickerWithNavigation.Android.dll",
		"FormsViewGroup.dll",
		...
		"XamarinPickerWithNavigation.dll",
	};
